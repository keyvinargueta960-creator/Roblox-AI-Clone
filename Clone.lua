...
local api=Instance.new("TextBox")
api.Size=UDim2.new(.9,0,0,35)
api.Position=UDim2.new(.05,0,0,80)
api.PlaceholderText="Gemini API Key"
api.Parent=main

Instance.new("UICorner",api)

local paste=Instance.new("TextButton")
paste.Size=UDim2.new(.25,0,0,30)
paste.Position=UDim2.new(.7,0,0,120)
paste.Text="Paste"
paste.Parent=main
...
for i,v in ipairs(names) do
    ...
    b.Position=UDim2.new(.05,0,0,150+(i-1)*55)
    b.Text=v
    b.Parent=main
...
notif.Position=UDim2.new(.5,-130,1,-80)
notif.BackgroundTransparency=.15
notif.Visible=false
notif.Parent=gui
